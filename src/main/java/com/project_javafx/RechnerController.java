...
public class RechnerController {
    ...
    private void onClickActionInput(Button btnInput, StringBuilder together, StringBuilder lab) {
        String str = "";
        HashMap<Object, String> selection = new HashMap<>();
        selection.put(btnAddition, " + ");
        selection.put(btnSubstraction, " - ");
        selection.put(btnMultiplication, " * ");
        selection.put(btnDivision, " / ");
        ...
        if (btnInput.equals(btnFak)){
            if (lab.length() > 0 && lab.indexOf("!") == -1) {
                ...
                berechnungsSchritte.setText(together.toString());
                BigInteger fact = Calculator.factorial(BigInteger.valueOf(Long.parseLong(lab.toString())));
                lab.setLength(0);
                together.setLength(0);
    ...
    public void onClickAbout(ActionEvent actionEvent) {
        ...
        alert.setHeaderText(null);
        alert.setContentText("2022 © Michael & Dennis");
